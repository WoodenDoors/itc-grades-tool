    ...
    <body>
        <header>
            <section id="user-control">
                Logged in as: <span class="username">mwegmann</span>
            </section>
            <h1>ITC Noten-Tool</h1>
        </header>
        
        <section id="main">
            <nav>
                <ul>
                    <li class="active"><a href="#" id="link-home">Startseite</a></li>
                    <li><a href="#">Notenübersicht</a></li>
                    <li><a href="#">Noten eintragen</a></li>
                    <li><a href="#">Grafen</a></li>
